    ...
    flake-utils.lib.eachSystem [ flake-utils.lib.system.x86_64-linux ] (
      ...
      let
        ...
        mkOidPackage =
          llvmPackages:
          with pkgs;
          pkgs.llvmPackages_15.stdenv.mkDerivation rec {
            name = "oid";
            ...
            buildInputs = [
              ...
              llvmPackages_15.openmp # should match the stdenv clang version, see: https://github.com/NixOS/nixpkgs/issues/79818
            ];
