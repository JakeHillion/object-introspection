...
Type& ClangTypeParser::enumerateType(const clang::Type& ty) {
  ...
  switch (ty.getTypeClass()) {
    ...
    case clang::Type::UnaryTransform:
      return enumerateUnaryTransformType(llvm::cast<const clang::UnaryTransformType>(ty));
...
Type& ClangTypeParser::enumerateUnaryTransformType(const clang::UnaryTransformType& ty) {
...
std::optional<TemplateParam> ClangTypeParser::enumerateTemplateTemplateParam(const clang::TemplateName& tn) {
  switch (tn.getKind()) {
...
ContainerInfo* ClangTypeParser::getContainerInfo(const std::string& fqName) const {
