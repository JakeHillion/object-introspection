...
int OIGenerator::generate(clang::tooling::CompilationDatabase& db,
  ...
  std::string code;
  codegen.generate(ctx.typeGraph, code, nullptr);
...
class CreateTypeGraphConsumer : public clang::ASTConsumer {
 ...
 public:
  ...
  void HandleTranslationUnit(clang::ASTContext& Context) override {
    LOG(ERROR) << "CreateTypeGraphConsumer::HandleTranslationUnit";
    ...
    type_graph::ClangTypeParser parser{ctx.typeGraph, opts};
